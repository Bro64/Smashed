...
{  
  static float vel = 0.2; // emn was 1.0

  /* Data reading of controller 1  */
  nuContDataGetEx(contdata,0);

  /* Change the display position according to stick data  */
  triPos_x += 0.1*contdata->stick_x; // was // triPos_x = contdata->stick_x; 
  triPos_y += 0.1*contdata->stick_y; // was // triPos_y = contdata->stick_y;
...
static Vtx shade_vtx[] =  {
        {        -64,  1, -5, 0, 0, 0, 0xff, 0, 0xff, 0xff	},
        {         64,  64, 5, 0, 0, 0, 0, 0, 0, 0xff	},
        {         64, -1, -5, 0, 0, 0, 0xff, 0xff, 0, 0xff	},
